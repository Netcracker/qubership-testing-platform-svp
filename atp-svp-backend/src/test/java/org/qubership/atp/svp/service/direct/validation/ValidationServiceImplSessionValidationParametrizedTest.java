...
public class ValidationServiceImplSessionValidationParametrizedTest {
    ...
    public ValidationServiceImplSessionValidationParametrizedTest(ValidationStatus validationStatus1,
    ...
    public static List<Object[]> sessionValidationStatusByPageValidationStatuses() {
        // The first three statuses are the actual status of the pages,
        // the fourth status is the expected status of the session
        return Arrays.asList(new ValidationStatus[][]{
                // Result session status - FAILED
                {ValidationStatus.WARNING, ValidationStatus.WARNING, ValidationStatus.WARNING, ValidationStatus.FAILED},
                {ValidationStatus.WARNING, ValidationStatus.NONE, ValidationStatus.WARNING, ValidationStatus.FAILED},
                {ValidationStatus.WARNING, ValidationStatus.PASSED, ValidationStatus.WARNING, ValidationStatus.FAILED},
                {ValidationStatus.WARNING, ValidationStatus.MANUAL, ValidationStatus.WARNING, ValidationStatus.FAILED},
    ...
    @Test
    public void calculateValidationStatus_differentStatuses_returnsCorrectStatus() {
        ValidationStatus actualValidationStatus = validationService.calculateStatusForSession(mock);
