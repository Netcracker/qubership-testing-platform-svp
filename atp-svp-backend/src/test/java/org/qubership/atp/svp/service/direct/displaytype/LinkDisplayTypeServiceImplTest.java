...
public class LinkDisplayTypeServiceImplTest {
    ...
    public void getValueFromSource_errorWhileGettingDataEngineTypeSQL_throwsGettingValueException()
        ...
        linkDisplayTypeService.getValueFromSource(source, parameterExecutionContext);
    }

    @Test(expected = GettingValueException.class)
    public void getValueFromSource_errorWhileGettingDataEngineTypeCassandra_throwsGettingValueException()
            throws GettingValueException {
    ...
    @Test
    public void getValueFromSource_tableDataAndEngineTypeNotSpecified_throwGettingValueException() {
        ...
        try {
            ...
            Assert.assertEquals("Unexpected EngineType value: LOG_COLLECTOR for DisplayType: LINK",
                    ex.getMessage());
        }
    }
    ...
    // Positive test cases
    @Test()
    public void getValueFromSource_tableData_returnsSimpleValueObjectWithFirstCellData()
            throws GettingValueException {
        Source source = new Source("", "", EngineType.SQL,
                "", new HashSet<>());
        ...
        AbstractValueObject actualResult = linkDisplayTypeService.getValueFromSource(source, parameterExecutionContext);
    ...
    @Test
    public void getValueFromSource_tableDataAndEngineTypeCassandra_returnsSimpleValueObjectWithFirstCellData()
            throws GettingValueException {
        Source source = new Source("", "", EngineType.CASSANDRA,
                "", new HashSet<>());
        String erValue = "erValue";
