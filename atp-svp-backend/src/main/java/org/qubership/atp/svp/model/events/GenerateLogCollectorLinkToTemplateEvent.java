...
public class GenerateLogCollectorLinkToTemplateEvent extends ParameterEvent {

    @Builder
    public GenerateLogCollectorLinkToTemplateEvent(@NonNull SutParameterExecutionContext parameterExecutionContext) {
