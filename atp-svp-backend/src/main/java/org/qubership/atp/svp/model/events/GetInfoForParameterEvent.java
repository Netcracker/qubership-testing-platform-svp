...
public class GetInfoForParameterEvent extends ParameterEvent {

    @Builder
    public GetInfoForParameterEvent(@NonNull SutParameterExecutionContext parameterExecutionContext) {
