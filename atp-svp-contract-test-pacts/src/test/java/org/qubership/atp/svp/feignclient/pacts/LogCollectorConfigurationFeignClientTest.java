...
@EnableFeignClients(clients = {LogCollectorConfigurationFeignClient.class})
@ContextConfiguration(classes = {LogCollectorConfigurationFeignClientTest.TestApp.class})
...
public class LogCollectorConfigurationFeignClientTest {
    ...
    public void allPass() {
        ...
        ResponseEntity<List<ConfigurationDto>> logCollectorConfigurations = logCollectorConfigurationFeignClient.getConfigurationsByProjectId(projectId);
        Assert.assertEquals(200, logCollectorConfigurations.getStatusCode().value());
        Assert.assertTrue(logCollectorConfigurations.getHeaders().get("Content-Type").contains("application/json"));
    }
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        DslPart getConfigurationsResponse = PactDslJsonArray.arrayEachLike()
                .booleanType("active")
                .stringType("entityType", "CONFIGURATION")
                .stringType("created")
                .stringType("createdBy")
                .uuid("id")
                .stringType("modified")
                .stringType("modifiedBy")
                .stringType("name")
                .uuid("projectId")
                .stringType("type")
                .object("parameters");
        ...
        PactDslResponse response = builder
                .given("all ok")
                .uponReceiving("GET /api/configurations/project/{projectId} OK")
                .path("/api/configurations/project/61abd5ac-efbe-49cc-b7f5-925a7f543481")
                .method("GET")
                .willRespondWith()
                .status(200)
                .headers(headers)
